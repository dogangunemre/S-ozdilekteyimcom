            ...
            if (!c)
            {
                ...
                if (probul == null)
                {
                    ...
                    try
                    {
                        ...
                        driver.FindElements(By.XPath("//*[@id='collapse2']/div/div[1]/p"));
                    ...
                    {
                        //Description
                        IReadOnlyCollection<IWebElement> DesciriptionPath = driver.FindElements(By.XPath("//*[@id='collapse2']/div/div[1]/p"));
                        string DescriptionCode = null;
                        foreach (IWebElement DesciriptionPathi in DesciriptionPath)
                        {
                            DescriptionCode = DesciriptionPathi.GetAttribute("innerHTML");
